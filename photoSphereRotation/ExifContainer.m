...
- (void)addMakeInfo:(NSString*)info{
    [self.tiffDictionary setObject:info forKey:(NSString*)kCGImagePropertyTIFFMake];
}
- (void)addModelInfo:(NSString*)info{
    [self.tiffDictionary setObject:info forKey:(NSString*)kCGImagePropertyTIFFModel];
}
